...
<!--								--><?//=CNext::showCabinetLink(true, false, '');?>
                                <?if (($USER->IsAuthorized() && SITE_ID == "s2") || ($USER->IsAuthorized() && SITE_ID == "s1")) {?>
                                    <a rel="nofollow" title="Авторизация для партнеров" class="personal-link dark-color" href="http://b2b.td-irbis.ru/personal/"><i class="svg inline  svg-inline-cabinet" aria-hidden="true" title="Мой кабинет"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="17" viewBox="0 0 14 17">
                                                <defs>
                                                    <style>
                                                        .uscls-1 {
                                                            fill: #222;
